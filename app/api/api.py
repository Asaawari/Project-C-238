# line 3 to 10 - importing required libraries
...
# line 14 - making a blueprint called 'api'

api = Blueprint('api', __name__, url_prefix="/api")

UPLOAD_FOLDER = os.path.abspath("app/static/attachments")

# line 20 to 48 - making a function called 'login'
...
# line 52 to 66 - making a function called 'logout'
...
# line 70 to 91 - making a function called 'add_address'
...
# line 95 to 114 - making a fucntion called 'create_order'
...
# line 118 to 134 - making a function called 'submit_help'
...
# line 138 to 140 - making a function called 'download'

@api.route("/download/<path:filename>")
def download(filename):
    return send_file(os.path.join(UPLOAD_FOLDER, filename), as_attachment=True)

# line 144 to 159 - making a function called 'search_order'
...
# line 163 to 188 - making a function called 'execute'
