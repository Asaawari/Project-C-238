# line 3 to 7 - importing required libraries
...
# line 11 to 21 - making class 'Orders'
...
class Orders(db.Model):
    ...
    # line 27 to 38 - creating a function called 'create'
    ...
    # line 42 to 45 - creating a function called 'update'
