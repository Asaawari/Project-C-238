# line 3 to 18 - importing all required libraries
...
# line 22 - making a flask group called cli

cli = FlaskGroup(create_app=create_app)

# line 26 to 117 - adding values in the json of 'user_json'
...
# line 121 to 199 - adding values in the json of 'product_json'
...
# line 203 to 206 - making a function called 'recreate_db' and performing 'drop_all','create_all' and 'session.commit' commands on the db
...
# line 210 to 257 - making a function called 'seeder', creating 'Users','Products','Customer','Supplier','CompanyProducts','CompanyOrders' and 'OrderItems' and seeding the editor
...
# line 263 to 266 - making a function called 'rsd' where we are calling the 'recreate_db' and 'seeder' functions
